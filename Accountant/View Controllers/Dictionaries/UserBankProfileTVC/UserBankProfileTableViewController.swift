...
class UserBankProfileTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.title = NSLocalizedString("Bank profiles", tableName: Constants.Localizable.userBankProfileTVC, comment: "")
    ...
    override func tableView(_ tableView: UITableView, trailingSwipeActionsConfigurationForRowAt indexPath: IndexPath) -> UISwipeActionsConfiguration? {
        ...
        let changeActiveStatus = UIContextualAction(style: .normal, title: nil) { (contAct, view, complete) in
            ...
            var message = NSLocalizedString("Do you want activate this bank profile in the app? Please note that you need manually activate each bank account for this profile", tableName: Constants.Localizable.userBankProfileTVC, comment: "")
            if selectedUBP.active {
                title = NSLocalizedString("Deactivate", tableName: Constants.Localizable.userBankProfileTVC, comment: "")
                message = NSLocalizedString("Do you want deactivate this bank profile in the app?", tableName: Constants.Localizable.userBankProfileTVC, comment: "")
            }
            ...
            alert.addAction(UIAlertAction(title: NSLocalizedString("Cancel", tableName: Constants.Localizable.userBankProfileTVC, comment: ""), style: .cancel))
        ...
        let delete = UIContextualAction(style: .normal, title: nil) { (contAct, view, complete) in
            ...
            let alert = UIAlertController(title: NSLocalizedString("Delete", tableName: Constants.Localizable.userBankProfileTVC, comment: ""),
                                          message: NSLocalizedString("Do you want delete this bank profile in the app? All transactions related to this bank profile will be kept. Please enter \"MyBudget: Finance keeper\" to confirm this action", tableName: Constants.Localizable.userBankProfileTVC, comment: ""),
                                          preferredStyle: .alert)
            
            alert.addTextField()
            alert.addAction(UIAlertAction(title: NSLocalizedString("Yes", tableName: Constants.Localizable.userBankProfileTVC, comment: ""), style: .default, handler: { [weak alert] (_) in
    ...
    func errorHandler(error : Error) {
        if error is AppError {
            let alert = UIAlertController(title: NSLocalizedString("Warning", tableName: Constants.Localizable.userBankProfileTVC, comment: ""), message: error.localizedDescription, preferredStyle: .alert)
            alert.addAction(UIAlertAction(title: NSLocalizedString("OK", tableName: Constants.Localizable.userBankProfileTVC, comment: ""), style: .default, handler: nil))
            self.present(alert, animated: true, completion: nil)
        }
        else {
            let alert = UIAlertController(title: NSLocalizedString("Error", tableName: Constants.Localizable.userBankProfileTVC, comment: ""), message: error.localizedDescription, preferredStyle: .alert)
            alert.addAction(UIAlertAction(title: NSLocalizedString("OK", tableName: Constants.Localizable.userBankProfileTVC, comment: ""), style: .default, handler: { [self](_) in
