//
//  AccountEditorWithInitialBalanceViewController1.swift
//  Accountant
//
//  Created by Roman Topchii on 15.09.2021.
//
...
//        mainScrollView.contentSize = CGSize(width: mainScrollView.frame.width, height: mainScrollView.frame.height)
        ...
        stepLabel.trailingAnchor.constraint(equalTo: mainView.trailingAnchor, constant: -10).isActive = true
...
extension AccountEditorWithInitialBalanceViewController1: CurrencyReceiverDelegate{
