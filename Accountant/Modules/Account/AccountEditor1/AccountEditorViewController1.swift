...
class AccountEditorViewController1: UIViewController { // swiftlint:disable:this type_body_length
...
//    private(set) var accountSubType: Account.SubTypeEnum?
    ...
    private lazy var mainView: AccountEditorView1 = {return AccountEditorView1(controller: self)}()
...
//            }
            ...
            holder = try? HolderHelper.getMe(context: context)
...
//                accountSubType = .debitCard
        ...
        do {
            if let account = account {
                ...
                if mainView.name == "" {
                    ...
                    else {throw Account.Error.accountAlreadyExists(name: mainView.name)}
                    context.rollback()
    ...
    private func getRootAccounts() {
        let rootAccountList = AccountHelper.getRootAccountList(context: context)
...
// MARK: - Routing
extension AccountEditorViewController1 {
...
extension AccountEditorViewController1: UIScrollViewDelegate {
...
extension AccountEditorViewController1: CurrencyReceiverDelegate {
...
extension AccountEditorViewController1: KeeperReceiverDelegate {
...
extension AccountEditorViewController1: HolderReceiverDelegate {
