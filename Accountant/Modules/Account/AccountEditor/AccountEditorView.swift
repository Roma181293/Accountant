...
class AccountEditorView: UIView { // swiftlint:disable:this type_body_length

    unowned var controller: AccountEditorViewController
    ...
    required init(controller: AccountEditorViewController) {
