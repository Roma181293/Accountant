...
extension AccountError: LocalizedError {
    public var errorDescription: String? {
        ...
        case let .creditAccountAlreadyExist(name):
            return String(format: NSLocalizedString("We create an associated credit account with your credit cards. Credit account \"%@\" already exists",comment: ""),name) //AccountsNameLocalisationManager.getLocalizedAccountName(.credits)+":"+name)
